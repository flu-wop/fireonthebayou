...
export const metadata: Metadata = {
  ...
  description: "Fire on the Bayou privacy policy.",
};
      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="bg-charcoal border border-border rounded-sm p-8 sm:p-12">
          <p className="text-mist leading-relaxed mb-6">
            This site does not collect personal information directly. Contacting us via the email link on this site sends your message through your own email provider — we don't capture or store anything through the site itself.
          </p>
          <p className="text-mist leading-relaxed mb-6">
